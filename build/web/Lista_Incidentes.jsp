...
<html lang="en">
    ...
    <body class="mod-bg-1 ">
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item">Incidentes</li>
                            <li class="breadcrumb-item active">Lista de Incidentes</li>
                            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
                        </ol>
                        
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-table'></i> Lista de: <span class='fw-300'>Incidentes</span>
                                <small>
                                    Listado de todos los incidentes que se han presentado
                                </small>
                            </h1>
                        </div>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form id="formulario" class="form" method="post" autocomplete="off" action="Controlador_Incidente">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="form-label" for="txtUsuarioFK">Usuario</label>
                                                                    <select class="form-control" id="txtUsuarioFK" name="txtUsuarioFK" required="required">
                                                                        <%

                                                                            List<Usuario> listadoUsuarios = Modelo_Usuario.listaUsuarios(-1);

                                                                            for (Usuario u : listadoUsuarios) {

                                                                        %> 
                                                                            <option value="<%=u.getId_usuario()%>"><%=u.getCodigo_usuario()%></option>
                                                                        <%
                                                                            }
                                                                        %>
                                                                    </select>
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="form-label" for="txtCalificacion">Calificacion</label>
                                                                    <input type="text" onkeyup="limpiarNumero(this)" onchange="limpiarNumero(this)" id="txtCalificacion" name="txtCalificacion" maxlength="2" required="required" class="form-control">
                                                                </div>
                                            ...
                                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <%
                                                        ...
                                                        List<Incidente> listaIncidentes = Modelo_Incidente.listaIncidentes(-1);
                                                    ...
                                                    <tr>
                                                        <td><%= u.getId_incidente() %></td>
                                                        <td><%= u.getCodigo_incidente() %></td>
                                                        <td><%= u.getDescripcion_incidente() %></td>
                                                        <td><%= u.getFecha_incidente() %></td>
                                                        
                                                        <td>
                                                            
                                                            <%

                                                                int estado = u.getEstado_incidente();
                                                        ...
                                                        <td><%= u.getCalificacion_incidente() %></td>
                                                        
                                                        <td>
                                                            <%
                                                                if(u.getoUsuario()==null){
                                                                    %>
                                                                        <a href="#" class="badge badge-danger">No existe</a>
                                                                    <%
                                                                } else {
                                                                    %>
                                                                        <a><%= u.getoUsuario().getCodigo_usuario() %></a>
                                                                    <%
                                                                }
                                                            %>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <input type="image" src="img/editar.png" data-toggle="modal" data-target="#default-example-modal" onclick="Mostrar(<%=u.getId_incidente()%>,'<%=u.getCodigo_incidente()%>','<%=u.getEstado_incidente()%>','<%=u.getCalificacion_incidente()%>','<%=u.getId_usuario_fk()%>','<%=u.getDescripcion_incidente()%>','M')">
                                                        </td>
                                                        <td>
                                                            
                                                            <form action="Controlador_Incidente" method="post">

                                                                <input type="hidden" name="txtId" value="<%=u.getId_incidente()%>"> 
        ...
        <script type="text/javascript">
                                   //'','',    '',    '',      , '',        '',      'I'
            var Mostrar = function(id,codigo,estado,calificacion,usuario,descripcion,modo){
                ...
                document.getElementById("txtCalificacion").value = calificacion;
                document.getElementById("txtDescripcion").value = descripcion;
                
                //document.getElementById("txtUsuarioFk").value = usuario;
                
                if(modo=="I"){
                    document.getElementById("tituloModal").innerHTML = "Nuevo Incidente";
                    document.getElementById("btnGuardar").innerHTML = "Guardar";
                    
                    document.getElementById("opcion").value = modo;
                    
                } else {
                    document.getElementById("tituloModal").innerHTML = "Modificar Incidente";
                    document.getElementById("btnGuardar").innerHTML = "Modificar";
                
                    $("#txtEstado").val(estado);
                    $("#txtUsuarioFK").val(usuario);
