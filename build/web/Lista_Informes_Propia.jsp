...
<%@page import="modelos.Modelo_Solucion"%>
<%@page import="beans.Solucion"%>
<%@page import="modelos.Modelo_Problema"%>
<%@page import="beans.Problema"%>
<%@page import="modelos.Modelo_Incidente"%>
<%@page import="beans.Incidente"%>
<%@page import="modelos.Modelo_Informe"%>
<%@page import="beans.Informe_Final"%>
...
<html lang="en">
    ...
    <body class="mod-bg-1 ">
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Lista de Informes</li>
                            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
                        </ol>
                        
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-table'></i> Lista de: <span class='fw-300'>Informes</span>
                                <small>
                                    Listado de todos los informes que se han presentado
                                </small>
                            </h1>
                        </div>
                                ...
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            ...
                                            <!-- EL ADMI NO PUEDE CREAR INFORMES-->
                                            <%
                                                if(Integer.parseInt(String.valueOf(session.getAttribute("tipoCUENTA")))==1){
                                            %>
                                            ...
                                            %>
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#default-example-modal" onclick="Mostrar('','','','','','W')" >Agregar</button>
                                            <%
                                                }
                                            %>
                                            <br><br>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form id="formulario" class="form" method="post" autocomplete="off" action="Controlador_Informe">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="form-label" for="txtIncidenteFK">Incidente</label>
                                                                    <select class="form-control" id="txtIncidenteFK" name="txtIncidenteFK" required="required">
                                                                        <%

                                                                            List<Incidente> listaIncidentes = Modelo_Incidente.listaIncidentes(Integer.parseInt(String.valueOf(session.getAttribute("idCUENTA"))));

                                                                            for (Incidente u : listaIncidentes) {

                                                                        %> 
                                                                            <option value="<%=u.getId_incidente()%>"><%=u.getCodigo_incidente()%> - <%=u.getDescripcion_incidente()%></option>
                                                                        <%
                                                                            }
                                                                        %>
                                                                    </select>
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="form-label" for="txtProblemaFK">Problema</label>
                                                                    <select class="form-control" id="txtProblemaFK" name="txtProblemaFK" required="required">
                                                                        <%
                                                                        ...
                                                                        %> 
                                                                            <option value="<%=u.getId_problema()%>"><%=u.getCodigo_problema()%> - <%=u.getDescripcion_problema()%></option>
                                                                        <%
                                                                            }
                                                                        %>
                                                                    </select>
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="form-label" for="txtSolucionFK">Solución</label>
                                                                    <select class="form-control" id="txtSolucionFK" name="txtSolucionFK" required="required">
                                                                        <%

                                                                            List<Solucion> listaSoluciones = Modelo_Solucion.listaSoluciones(-1);

                                                                            for (Solucion u : listaSoluciones) {

                                                                        %> 
                                                                            <option value="<%=u.getId_solucion()%>"><%=u.getCodigo_solucion()%> - <%=u.getDescripcion_solucion()%></option>
                                                                        <%
                                                                            }
                                                                        %>
                                                                    </select>
                                                                ...
                                                                <input type="hidden" id="txtUsuarioFk" name="txtUsuarioFk" value="">
                                                                
                                                                <input type="hidden" id="opcion" name="opcion" value="W">
                                            ...
                                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <%
                                                        ...
                                                        List<Informe_Final> listaInformes = Modelo_Informe.listaInformes();
                                
                                                        for (Informe_Final u : listaInformes) {
                                                            
                                                            // FILTRO PARA SOLO RECIBIR INFORMES PROPIOS
                                                            //if(u.getoIncidente().getoUsuario().getId_usuario()==Integer.parseInt(String.valueOf(session.getAttribute("idCUENTA")))){
                                                            if(u.getoIncidente().getoUsuario().getId_usuario()==Integer.parseInt(String.valueOf(session.getAttribute("idCUENTA")))){
                                                                %>
                                                                
                                                                    <tr>
                                                                        <td><%= u.getId_informe() %></td>
                                                                        <td><%= u.getHora_final_informe() %></td>
                                                                        <td><%= u.getDescripcion() %></td>

                                                                        <td>
                                                                            <%
                                                                                if(u.getoIncidente()==null){
                                                                                    %>
                                                                                        <a href="#" class="badge badge-danger">No existe</a>
                                                                                    <%
                                                                                } else {
                                                                                    %>
                                                                                    <a><%= u.getoIncidente().getCodigo_incidente() %></a>
                                                                                    <%
                                                                                }
                                                                            %>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <%
                                                                                if(u.getoProblema()==null){
                                                                                    %>
                                                                                        <a href="#" class="badge badge-danger">No existe</a>
                                                                                    <%
                                                                                } else {
                                                                                    %>
                                                                                    <a><%= u.getoProblema().getCodigo_problema() %></a>
                                                                                    <%
                                                                                }
                                                                            %>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <%
                                                                                if(u.getoSolucion()==null){
                                                                                    %>
                                                                                        <a href="#" class="badge badge-danger">No existe</a>
                                                                                    <%
                                                                                } else {
                                                                                    %>
                                                                                    <a><%= u.getoSolucion().getCodigo_solucion() %></a>
                                                                                    <%
                                                                                }
                                                                            %>
                                                                        </td>
                                                                        <!--
                                                                        <td>
                                                                            <input type="image" src="img/editar.png" data-toggle="modal" data-target="#default-example-modal" onclick="Mostrar(<%=u.getId_informe()%>,'<%=u.getDescripcion()%>','<%=u.getId_incidente_fk()%>','<%=u.getId_problema_fk()%>','<%=u.getId_solucion_fk()%>','M')">
                                                                        </td>
                                                                        -->
                                                                        <td>

                                                                            <form action="Controlador_Informe" method="post">

                                                                                <input type="hidden" name="txtId" value="<%=u.getId_informe()%>"> 

                                                                                <input type="hidden" name="opcion" value="Y">
        ...
        <script type="text/javascript">
                                   //'','',    '',    '',      , '',        '',      'I'
            var Mostrar = function(id,descripcion,incidente,problema,solucion,modo){
                
                document.getElementById("txtId").value = id;
                document.getElementById("txtDescripcion").value = descripcion;
                
                if(modo=="W"){
                    document.getElementById("tituloModal").innerHTML = "Nuevo Informe";
                    document.getElementById("btnGuardar").innerHTML = "Guardar";
                    
                    document.getElementById("opcion").value = modo;
                    
                } else {
                    document.getElementById("tituloModal").innerHTML = "Modificar informe";
                    document.getElementById("btnGuardar").innerHTML = "Modificar";
                
                    alert(incidente+" - "+problema+" - "+solucion);
                    $("#txtIncidenteFk").val(incidente);
                    //$("#txtProblemaFk").val(problema);
                    //$("#txtSolucionFk").val(solucion);
        ...
        <%
            if(ALERTA!=null){
                if(ALERTA.equals("EXISTE_CODIGO")){
                    %>
                    <script>
