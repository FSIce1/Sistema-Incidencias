                            ...
                            <li class="active open">
                                ...
                                <ul>
                                    ...
                                    %> <!-- TECNICO -->
                                        ...
                                        <li>
                                            <a href="Lista_Informes_Propia.jsp" title="Lista de Informes Propias" data-filter-tags="Lista de Informes Propias">
                                                <span class="nav-link-text" data-i18n="nav.plugins_waves">Lista de Informes Propias</span>
                                            </a>
                                        </li>
