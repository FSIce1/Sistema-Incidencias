...
<html lang="en">
    ...
    <body class="mod-bg-1 ">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-table'></i> Lista de: <span class='fw-300'>Usuarios</span>
                                <small>
                                    Listado de todos los usuarios (Administrados y Técnicos)
                                </small>
                            </h1>
                        </div>
                                ...
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            ...
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#default-example-modal" onclick="Mostrar('','','','','','','','','','X')" >Agregar</button>
                                            <br><br> 
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form id="formulario" class="form" method="post" autocomplete="off" action="Controlador_Usuario">
                                                                                                                                
                                                                <div class="form-group">
                                                                    <label class="form-label" for="txtNombres">Nombres</label>
                                                                    <input type="text" id="txtNombres" name="txtNombres" maxlength="20" required="required" class="form-control">
                                                                </div>
                                                                
                                                                <div class="form-group">
                                                                    <label class="form-label" for="txtApellidos">Apellidos</label>
                                                                    <input type="text" id="txtApellidos" name="txtApellidos" maxlength="20" required="required" class="form-control">
                                                                </div>
                                                              
                                                                <div class="form-group">
                                                                    <label class="form-label" for="txtCorreo">Correo</label>
                                                                    <input type="text" id="txtCorreo" name="txtCorreo" maxlength="50" required="required" class="form-control">
                                                                </div>
                                                                
                                                                <div class="form-group">
                                                                    <label class="form-label" for="txtTelefono">Teléfono</label>
                                                                    <input type="text" onkeyup="limpiarNumero(this)" onchange="limpiarNumero(this)" id="txtTelefono" name="txtTelefono" maxlength="9" required="required" class="form-control">
                                                                </div>
                                                                
                                                                <div class="form-group">
                                                                    <label class="form-label" for="txtCodigo">Código</label>
                                                                    <input type="text" id="txtCodigo" name="txtCodigo" maxlength="30" required="required" class="form-control">
                                                                </div>
                                                                
                                                                <div class="form-group">
                                                                    <label class="form-label" for="txtContra">Contraseña</label>
                                                                    <input type="password" id="txtContra" name="txtContra" maxlength="30" required="required" class="form-control">
                                                                </div>
                                                                
                                                                <div class="form-group">
                                                                    <label class="form-label" for="txtTipo">Tipo</label>
                                                                    <select class="form-control" id="txtTipo" name="txtTipo" required="required">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" id="txtEstado" name="txtEstado" required="required">
                                                                ...
                                                                <input type="hidden" id="txtEmailAntiguo" name="txtEmailAntiguo" value="">

                                                                <input type="hidden" id="txtId" name="txtId" value="">
                                                                
                                                                <input type="hidden" id="opcion" name="opcion" value="X">
                                            ...
                                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <%
                                                        ...
                                                        List<Usuario> listaUsuarios = Modelo_Usuario.listaUsuarios(-1);
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><%= u.getCorreo_usuario() %></td>
                                                        <td><%= u.getTelefono_usuario() %></td>
                                                        <td><%= u.getCodigo_usuario() %></td>
                                                        
                                                        <td>
                                                            
                                                            <%

                                                                int tipo = u.getTipo_usuario();
                                                             
                                                                if(tipo==0){
                                                                    %>
                                                                        <a href="#" class="badge badge-success">Técnico</a>
                                                                    <%
                                                                } else if(tipo==1){
                                                                    %>
                                                                        <a href="#" class="badge badge-danger">Administrador</a>
                                                                    <%
                                                                }
                                                        ...
                                                        <td>
                                                            ...
                                                            <%
                                                                ...
                                                                int estado = u.getEstado_usuario();
                                                        ...
                                                        <td>
                                                            <input type="image" src="img/editar.png" data-toggle="modal" data-target="#default-example-modal" onclick="Mostrar(<%=u.getId_usuario()%>,'<%=u.getNombres_usuario()%>','<%=u.getApellidos_usuario()%>','<%=u.getContra_usuario()%>','<%=u.getCorreo_usuario()%>','<%=u.getTelefono_usuario()%>','<%=u.getCodigo_usuario()%>','<%=u.getTipo_usuario()%>','<%=u.getEstado_usuario()%>','M')">
                                                        </td>
                                                        <!--
                                                        <td>
        ...
        <script type="text/javascript">
            ...
            var Mostrar = function(id,nombres,apellidos,contra,correo,telefono,codigo,tipo,estado,modo){   
                ...
                document.getElementById("txtContra").value = contra;
                
                
                document.getElementById("txtEmailAntiguo").value = correo;
        ...
        <%
            if(ALERTA!=null){
                if(ALERTA.equals("EXISTE_CODIGO")){
                    ...
                    <%
                } else if(ALERTA.equals("EXISTE_EMAIL")){
                    %>
                    <script>
                        toastr.info('Ya existe este email, no pudo ser registrado');
                    </script>
                    <%
