...
<html lang="en">
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Lista de Soluciones</li>
                            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
                        </ol>
                        
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-table'></i> Lista de: <span class='fw-300'>Soluciones</span>
                                <small>
                                    Listado de todos los soluciones que se han presentado o se puedan presentar
                                </small>
                            </h1>
                        </div>
                                        ...
                                        <div class="panel-content">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form id="formulario" class="form" method="post" autocomplete="off" action="Controlador_Solucion">
                                            ...
                                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><%= u.getId_solucion() %></td>
                                                        <td><%= u.getCodigo_solucion() %></td>
                                                        <td><%= u.getDescripcion_solucion() %></td>
                                                        <td>
                                                            <input type="image" src="img/editar.png" data-toggle="modal" data-target="#default-example-modal" onclick="Mostrar(<%=u.getId_solucion()%>,'<%=u.getCodigo_solucion()%>','<%=u.getDescripcion_solucion()%>','M')">
                                                        </td>
                                                        <td>
                                                            
                                                            <form action="Controlador_Solucion" method="post">

                                                                <input type="hidden" name="txtId" value="<%=u.getId_solucion()%>"> 
	...
	NOTE: 	The file size is pretty big, but you can always use the
        ...
        <script type="text/javascript">
            ...
            var Mostrar = function(id,codigo,descripcion,estado){
                ...
                if(estado=="I"){
                    document.getElementById("tituloModal").innerHTML = "Nueva Solución";
                    document.getElementById("btnGuardar").innerHTML = "Guardar";
                    
                    document.getElementById("opcion").value = estado;
                    
                } else {
                    document.getElementById("tituloModal").innerHTML = "Modificar Solución";
