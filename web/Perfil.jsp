                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-table'></i> Datos
                                <small>
                                    ...
                                    <div class="row no-gutters row-grid">
                                        <div class="col-12">
                                            <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                                <img src="img/profile-user-2.png" class="rounded-circle shadow-2 img-thumbnail" alt="">
                                                <h5 class="mb-0 fw-700 text-center mt-3">
                                                    <%=session.getAttribute("nombresCUENTA")%> <%=session.getAttribute("apellidosCUENTA")%>
                                                    <small class="text-muted mb-0">@<%=session.getAttribute("codigoCUENTA")%></small>
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="p-3 text-center">
                                                ...
                                                <a href="javascript:void(0);" class="btn-link font-weight-bold"></a> <span class="text-primary d-inline-block mx-3">&#9679;</span>
                                                <a href="javascript:void(0);" class="btn-link font-weight-bold">Conectado</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <a href="javascript:void(0);" class="d-flex flex-row align-items-center">
                                            ...
                                            <div class="ml-3">
                                                ...
                                                <br>
                                                <%=session.getAttribute("codigoCUENTA")%>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <a href="javascript:void(0);" class="d-flex flex-row align-items-center">
                                            ...
                                            <div class="ml-3">
                                                ...
                                                <br>
                                                <%=session.getAttribute("telefonoCUENTA")%>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-2">
                                    <div class="card-body">
                                        <a href="javascript:void(0);" class="d-flex flex-row align-items-center">
                                            <div class='icon-stack display-3 flex-shrink-0'>
                                                <i class="fal fa-circle icon-stack-3x opacity-100 color-primary-400"></i>
                                                <i class="fas fa-exclamation-triangle icon-stack-1x opacity-100 color-primary-500"></i>
                                            </div>
                                            <div class="ml-3">
                                                <strong>
                                                    Correo
                                                ...
                                                <br>
                                                <%=session.getAttribute("correoCUENTA")%>
                                            </div>
                                        </a>
                                    </div>
                                </div>
